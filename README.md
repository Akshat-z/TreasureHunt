...
### Overview:
 It is the  puzzle game that challenges players to solve complex puzzles by piecing together clues and solving riddles. It requires players to use a variety of soft skills in order to succeed in the game.
...
* **Level 1:** Guess The vegetable ?
  * **Solution:** potato
* **Level 2:** Which Oscar-winning movie does below rebus identifies ?
  * **Solution:** 12 angry men
* **Level 3:** Watch the video below and answer the question.
  * **Solution:** tamanna bhatia
* **Level 4:** In which language is the number 3 written in the previous puzzle?
  * **Solution:** russia
* **Level 5:** What has hands, but can't clap ?
  * **Solution:** clock
  
## Feature checklist

Login using email and password: Yes </br>
Minimum 5 clues: Yes</br>
Minimum 2 dead-ends: Yes</br>
Minimum 1 solution : Yes</br>
User data: Yes(Accuracy of each user at each clue page) </br>
Dashboard for admin for tracking user data: Yes </br>
...
* Open your terminal/command prompt from the project directory and run the file `server.js` by executing the following command
